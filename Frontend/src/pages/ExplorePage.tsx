  ...
  useEffect(() => {
    ...
    if (!leafletInstanceRef.current) {
      const map = L.map(mapRef.current, {
        center: [-5.4292, 105.2611], // Center around Bandar Lampung
        zoom: 9,
        zoomControl: false,
      });
    ...
    filteredDestinations.forEach((dest) => {
      ...
      // Custom Leaflet Pin HTML Marker
      const customIcon = L.divIcon({
        ...
        html: `
          <div style="
            ...
            align-items: center;
            gap: 6px;
            background: ${isSelected ? '#0D9488' : isHovered ? '#0F766E' : '#FFFFFF'};
            ...
            transform: scale(${isSelected || isHovered ? '1.1' : '1.0'});
          ">
    ...
    <div className="flex flex-col min-h-[100dvh] pt-24 pb-12">
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {/* LEFT: DESTINATIONS CARDS LIST (7 Cols) */}
          ...
          {/* RIGHT: INTERACTIVE SPATIAL MAP (5 Cols) */}
          <div className="lg:col-span-5 sticky top-24">
            <div className="glass-card-container rounded-[28px] overflow-hidden shadow-lg border border-slate-200/80 flex flex-col h-[calc(100vh-7.5rem)] min-h-[480px]">
              {/* Map Header */}
