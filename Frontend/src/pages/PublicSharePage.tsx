...
export const PublicSharePage: React.FC = () => {
  ...
  const handleCloneItinerary = () => {
    triggerToast('Itinerary berhasil disalin ke AI Planner Anda!');
        ...
        <div className="glass-card-container rounded-[28px] p-6 sm:p-8 space-y-4 relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 text-xs text-slate-500 font-medium">
              <UserCheck className="w-4 h-4 text-siger-500" />
              <span>Dibagikan oleh <strong>Travel Enthusiast Lampung</strong></span>
            </div>
          </div>

          <h1 className="text-2xl sm:text-3xl font-display font-extrabold text-slate-900 tracking-tight leading-tight">
            Rencana Perjalanan 3 Hari Wisata Eksotis Lampung
          </h1>
